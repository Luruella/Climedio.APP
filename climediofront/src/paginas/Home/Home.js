      ...
      <Sidebar>
        <Topbar>
          <div className={style.pagina_conteudo}>
            ...
            <p className={style.textoHome}>
              A história da CLIMÉDIO inicia-se com Dr Fedor Sanchez Pedemonte,
              mais conhecido como Dr Sanchez, formado pela UFMG em BH no ano de
